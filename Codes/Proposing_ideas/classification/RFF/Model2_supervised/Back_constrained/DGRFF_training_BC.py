...
import os
from DGRFF_opt_BC import Dgrff_opt
import pickle
import numpy as np
...
Domain_number=N_p
Hiddenlayerdim1,Hiddenlayerdim2=100,100
num_MC=10
Q=3 
n_rff=100
df=1
    ...
    while iteration < 50000:
        ...
        for index in range(n_train_batches):
            ...
            if iteration%10==0:
                ...
                #MMD=DGP.f['MMD'](index)
                KL_latent_dim=DGP.f['KL_latent_dim'](index)
                
                print(': KL_WX is:' + str(KL_WX)+ ': KL_WY is:' + str(KL_WY)+': KL_latent_dim is:' + str(KL_latent_dim))
                print ('and LL_Y is ' + str(LL_Y)+'and LL_X is ' + str(LL_X))#+'and MMD ' + str(MMD))
