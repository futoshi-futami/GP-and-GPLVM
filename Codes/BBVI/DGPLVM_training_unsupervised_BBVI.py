...
from DGPLVM_opt_unsupervised_BBVI import DGGPLVM_opt
import pickle
import numpy as np
...
dggplvm = DGGPLVM_opt(D,M,Q,Domain_number,X_tr,Weight_share,Xlabel_share,batch_size,Hiddenlayerdim1,Hiddenlayerdim2)
