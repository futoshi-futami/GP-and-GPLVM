# -*- coding: utf-8 -*-
"""
Created on Fri Feb 17 12:16:37 2017

@author: Futami
"""

import sys; sys.path.append("./")
#from SVI_GP_model import SVIGP
import numpy as np
...
from DG_GPLVM_model import DGGPLVM
model = DGGPLVM(initial_params)

#outputs = model.get_outputs(X, Y1, X_test) 

#outputsgrad=model.get_cost_grads['LL'](X, Y1) 
#plot_regression(x_val, y_val, x_test_val, outputs['y_test_mu'],outputs['y_test_var'],'Before Optimization')
    
#model.train_by_optimizer(X, Y1, iter=5000,batch_size=20,)
