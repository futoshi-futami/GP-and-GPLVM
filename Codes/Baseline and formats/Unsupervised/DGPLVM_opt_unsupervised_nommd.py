from DGPLVM_model_unsupervised_nommd import DGGPLVM_model
import numpy as np
...
class DGGPLVM_opt:
    def __init__(self, D, M,Q,Domain_number,train_set_x,train_weight,train_label,batch_size,m,pre_params,Pre_U,Hiddenlayerdim1,Hiddenlayerdim2,load=None):
        
        
        self.dggplvm = DGGPLVM_model( D, M,Q,Domain_number,m,pre_params,Pre_U,Hiddenlayerdim1,Hiddenlayerdim2)
