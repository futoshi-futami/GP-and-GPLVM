...
class GP_model:
    def __init__(self,N_tot,D_in,D_out,M,Domain_number,Ydim,Hiddenlayerdim1,Hiddenlayerdim2,num_MC):
        ...
        self.Gaussian_layer_X=KernelLayer(self.Data_input, D_in=D_in, D_out=D_out,num_MC=num_MC,inducing_number=M,Domain_number=Domain_number,Domain_consideration=True,number='_X')
        ...
        self.LL = self.Gaussian_layer_X.liklihood_nodomain(self.Y)*N_tot/N
