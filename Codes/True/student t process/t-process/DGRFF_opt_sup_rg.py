from DGRFF_model_sup_rg import Dgrff_model
import numpy as np

class Dgrff_opt:
    def __init__(self,N_tot,D,Q,Domain_number,Ydim,Hiddenlayerdim1,Hiddenlayerdim2,num_MC,n_rff,train_set_x,train_label,Y_tr,batch_size,Y_validate,X_validate,Y_test,X_test,batch_size2,free_param):
                
        self.dgrff = Dgrff_model(N_tot,D,Q,Domain_number,Ydim,Hiddenlayerdim1,Hiddenlayerdim2,num_MC,n_rff,free_param)
