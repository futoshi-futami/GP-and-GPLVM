...
from DGRFF_opt import Dgrff_opt
import pickle
import numpy as np
...
def one_step_opt():
    ...
    while iteration < 50000:
        ...
        for index in range(n_train_batches):
            optming_params={}
            alpha=DGP.dgrff.train_model(index,iteration,0.001,0)
            #alpha=DGP.dgrff.train_model(index)
            ...
            if iteration%5==0:
                ...
                print ('LL_X is:' + str(LL_X)+'and LL_Y is ' + str(LL_Y)+ ': KL_hidden is:' + str(KL_hidden))
