...
class DGGPLVM_opt:
    ...
    def get_grad_Y(self, param_name, int index):
        
        cdef double grad1,grad_std,grad
    ...
    def get_grad_X(self, param_name, int index):
    ...
    def get_grad_local(self, param_name, int index):
    ...
    def opt_one_step(self, int iteration,int index, opt = 'rmsprop', double learning_rate_adapt = 0.2, use_einsum = True):        
    ...
    def rmsprop_one_step_local(self, param_name, int index, grad_args, double decay = 0.9, double momentum = 0, learning_rate_adapt = 0.05, 
        double learning_rate_min = 1e-6, double learning_rate_max = 10):
        ...
        cdef double step1,grad,step2,step,adapt
    ...
    def rmsprop_one_step_globalX(self, param_name, int index, grad_args, decay = 0.9, momentum = 0, learning_rate_adapt = 0.05, 
    ...
    def rmsprop_one_step_globalY(self, param_name, int index, grad_args, double decay = 0.9, double momentum = 0, learning_rate_adapt = 0.05, 
        double learning_rate_min = 1e-6, double learning_rate_max = 10):
        # RMSPROP: Tieleman, T. and Hinton, G. (2012), Lecture 6.5 - rmsprop, COURSERA: Neural Networks for Machine Learning
        # Implementation based on https://github.com/BRML/climin/blob/master/climin/rmsprop.py
        cdef double step1,grad,step2,step,adapt
