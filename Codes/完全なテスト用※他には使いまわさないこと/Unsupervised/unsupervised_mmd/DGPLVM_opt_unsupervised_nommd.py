...
class DGGPLVM_opt:
    def __init__(self, D, M,Q,Domain_number,train_set_x,train_weight,train_label,batch_size,m,pre_params,Hiddenlayerdim1,Hiddenlayerdim2,load=None):
        
        
        self.dggplvm = DGGPLVM_model( D, M,Q,Domain_number,m,pre_params,Hiddenlayerdim1,Hiddenlayerdim2)
