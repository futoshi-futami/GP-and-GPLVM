...
class DGGPLVM_opt:
    def __init__(self,N_0, D, M,Q,Domain_number,train_set_x,train_weight,train_label,batch_size,Hiddenlayerdim1,Hiddenlayerdim2,load=None):
        
        
        self.dggplvm = DGGPLVM_model(N_0, D, M,Q,Domain_number,Hiddenlayerdim1,Hiddenlayerdim2)
